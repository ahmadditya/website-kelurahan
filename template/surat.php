...
if($jenis_surat == "SKA"){
	...
	$mengetahui .="<div style='text-transform:uppercase'>CAMAT ".$lurah["kecamatan"]."</div><div class='kosong'></div>";
	$mengetahui .="<div>_______________________</div></div>";	
	$mengetahui .= "<div class='tanda_tangan'>";
	$mengetahui .="<div style='text-transform:uppercase'>DANRAMIL ".$lurah["kecamatan"]."</div><div class='kosong'></div>";
	$mengetahui .="<div>_______________________</div></div>";	
	}
else {
	$mengetahui="";
...
<!-- awal kepala surat -->
<div id="kepala_surat"><img src="assets/img/kotaku.png" width="100px" height="100px" id="logo_surat" valign="baseline"/>
<strong>PEMERINTAHAN KELURAHAN <?php echo strtoupper($lurah['kabupaten']) ?><br/>
KECAMATAN  <?php echo strtoupper($lurah['kecamatan']) ?><br/>
lurah  <?php echo strtoupper($lurah['nama']) ?><br/></strong>
<?php echo ucwords($lurah['alamat']) ?> Telp. <?php echo $lurah['tlp'] ?>
</div>
<!-- akhir kepala surat -->
...
Kepala lurah <?php echo $lurah["nama"] ?>, 
Kecamatan <?php echo $lurah["kecamatan"] ?>, Kabupaten <?php echo $lurah["kabupaten"] ?> menerangkan dengan 
...
<div class="tanda_tangan" style="float:right">
	...
	if($ttd['nip'] == null){
		$tertanda = $lurah['tt_kades'];
		$nama_pejabat = $lurah['kades'];
		$nip_pejabat = $lurah['kades_nip'];
		}
	else {
		$tertanda = $lurah['tt_sekdes'];
		$nama_pejabat = $lurah['sekdes'];
		$nip_pejabat = $lurah['sekdes_nip'];
		}	
	?>
...
<div id="kepala_surat"><img src="img/kotaku.jpg" width="100px" height="100px" id="logo_surat" valign="baseline"/>
<strong>PEMERINTAHAN KABUPATEN <?php echo strtoupper($lurah['kabupaten']) ?><br/>
KECAMATAN  <?php echo strtoupper($lurah['kecamatan']) ?><br/>
LURAH  <?php echo strtoupper($lurah['nama']) ?><br/></strong>
<?php echo ucwords($lurah['alamat']) ?> Telp. <?php echo $lurah['tlp'] ?>
</div>
...
<div id="par_penutup"><span class="masuk_alinea">&nbsp;</span>Demikian Surat Keterangan ini diberikan, untuk 
digunakan sebaik baiknya.</div>
<div class="tanda_tangan" style="float:right">
	<div>Duduksampeyan, <?php echo date("d-m-Y") ?></div>
	<div class="kosong" id="pejabat"><?php echo $lurah["tt_kades"]; ?></div>
	<div id="nama_pejabat"><?php echo "<span style='text-transform:uppercase;text-decoration:underline'>".$lurah["kades"]."</span>"; ?></div>
</div>
<?php
}
?>
