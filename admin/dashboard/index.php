            ...
            <div class="col-lg-6">
              <div class="d-flex flex-column h-100">
                ...
                <div style="font-size: 35pt; font-weight: 500;">
                  <p>Halo, <strong></strong>
                </div>
                </p>
                <h5 class="font-weight-bolder"><?php echo $_SESSION['lvl']; ?></h5>

                <div style="font-size: 15pt; font-weight: 500;">
                  <p>Selamat datang di <a href="#" style="text-decoration:none"><strong>Web Aplikasi Pelayanan Administrasi Kelurahan Online.</strong></a></p>
                </div>
            ...
            <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
              <div class="bg-gradient-primary border-radius-lg h-100">
                ...
                <div class="position-relative d-flex align-items-center justify-content-center h-100">
                  <img style="max-width:300px; width:60%; height:auto;" src="../../assets/img/kotaku.png"><br>
    ...
    <div class="col-lg-5 mb-lg-0 mb-4">
      <div class="card z-index-2">
        <div class="card-body p-3">
          <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
            <div class="chart">
              <div id="chart-bars" class="chart-canvas" height="200">
                <iframe width="381" height="219" src="https://www.youtube-nocookie.com/embed/qCrsr4yLfbs?si=UjHfh_vHVAIJlJM_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
              </div>
            </div>
          </div>
          <h6 class="ms-2 mt-4 mb-0">Profil Kelurahan </h6>
      ...
      <div class="card z-index-2">
        <div class="card-header pb-0">
          ...
          <p class="text-sm">
            ...
            <span class="font-weight-bold">Kantor Lurah Padebuolo</span> Jl. Panca Krida, Padebuolo, Kec. Kota Tim., Kota Gorontalo, Gorontalo 96134
          </p>
        </div>
        <div class="card-body p-3">
          <div class="chart">

            <div id="chart-line" class="chart-canvas" height="200">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1410.552279393187!2d123.07200915425398!3d0.5350912278489537!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x32792ad62f58f4ed%3A0x8801ed8a00390636!2sKantor%20Lurah%20Padebuolo!5e0!3m2!1sid!2sid!4v1698304670903!5m2!1sid!2sid" width="560" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
